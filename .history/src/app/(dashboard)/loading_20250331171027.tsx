...
const LoadingPage = () => {
    return (
        <div className={"h-screen w-full fixed top-0 left-0 flex flex-col items-center justify-center bg-primary transition-opacity duration-500 ${shouldAnimateOut ? 'opacity-100' : 'opacity-0'}"}>
