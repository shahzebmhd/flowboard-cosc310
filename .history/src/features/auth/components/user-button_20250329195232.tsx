...
export const UserButton = () => {
    ...
    return(
        <div className={cn(
            "p-2 rounded-lg", // Add padding and rounded corners
            "bg-secondary" // Apply secondary background
        )}>
            <DropdownMenu modal={false}>
                ...
                <DottedSeparator className="mb-1"/>
                    <DropdownMenuItem 
                        onClick={() =>logout()}
                        className ="h-10 flex items-center justify-center text-amber-700 font-medium cursor-pointer hover:text-emphasis"
                    >
