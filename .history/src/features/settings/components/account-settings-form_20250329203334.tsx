                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <select
                                                    ...
                                                    className="block w-full rounded-md border border-neutral-300 bg-tertiary px-3 py-2 shadow-sm focus:border-primary focus:outline-none"
                                                >
                                    ...
                                    render= {({ field }) => (
                                        <FormItem>
                                            ...
                                            <Checkbox
                                                    ...
                                                    className="h-4 w-4 rounded-sm border-2 border-primary"
                                                >
