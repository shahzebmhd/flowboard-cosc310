                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <select
                                                    ...
                                                    className="block w-full rounded-md border-1 border-neutral-500 bg-tertiary px-3 py-2 shadow-sm focus:border-1 focus:outline-none"
                                                >
                                    ...
                                    render= {({ field }) => (
                                        <FormItem>
                                            ...
                                            <Checkbox
                                                    ...
                                                    className="h-4 w-4 rounded-sm border-1 border-primary"
                                                >
