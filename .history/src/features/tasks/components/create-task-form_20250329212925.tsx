                                    ...
                                    <FormItem>
                                        ...
                                        <Select defaultValue={field.value} onValueChange={field.onChange}>
                                            ...
                                            <SelectContent className="border-1 rounded-md bg-tertiary">
                                                <SelectItem value={TaskStatus.BACKLOG} className="p-2">Backlog</SelectItem>
                                                <SelectItem value={TaskStatus.IN_PROGRESS} className="p-2">In Progress</SelectItem>
                                                <SelectItem value={TaskStatus.IN_REVIEW} className="p-2">In Review</SelectItem>
                                                <SelectItem value={TaskStatus.TODO} className="p-2">To Do</SelectItem>
                                                <SelectItem value={TaskStatus.DONE} className="p-2">Done</SelectItem>
                                            </SelectContent>
                                        </Select>
                                        <FormMessage />
                                    </FormItem>
