                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select defaultValue={field.value} onValueChange={field.onChange}>
                                            <FormControl>
                                                <SelectTrigger>
                                                    <SelectValue placeholder="Select status" className="border-1 rounded-md bg-tertiary"/>
                                                </SelectTrigger>
                                            </FormControl>
                                            <SelectContent>
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select defaultValue={field.value} onValueChange={field.onChange}>
                                            <FormControl>
                                                <SelectTrigger>
                                                    <SelectValue placeholder="Select project" className="border-1 rounded-md bg-tertiary"/>
                                                </SelectTrigger>
                                            </FormControl>
                                            <SelectContent>
