    ...
    return (
        <aside className="h-full p-4 w-full bg-secondary">
            ...
            <div className="flex flex-row items-center gap-x-2">
                ...
                <span className="font-bold text-4xl h-[56px] inline-flex items-center [transform:scaleY(1.55)] origin-center text-[var(--text-hover)] dark:text-[var(--text-logo)]">Flowboard</span>
            </div>
