...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-netural-300 border border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-b from-[var(--primary-foreground)] to-[var(--primary)] text-primary-foreground hover:from-[var(--primary)] hover:to-[var(--primary)]",
        destructive:
          "bg-gradient-to-b from-[var(destructive-foreground)] to-[var(destructive)] text-destructive-foreground hover:from-[var(destructive)] hover:to-[var(destructive)]",
        outline:
          "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-quaternary text-black hover:bg-neutral-100",
