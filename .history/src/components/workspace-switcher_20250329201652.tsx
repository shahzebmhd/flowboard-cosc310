                ...
                <Select onValueChange={onSelect} value={workspaceId}>
                    ...
                    <SelectContent className="bg-tertiary">
                        ...
                        {workspaces?.documents.map((workspace: { $id: string, name: string, imageUrl: string }) => (
                            <SelectItem key={workspace.$id} value={workspace.$id} className="hover:opacity-75 transition">
                                <div className="flex items-center gap-2">
                                    <WorkspaceAvatar name={workspace.name} image={workspace.imageUrl} className=" hover:text-emphasis"/>
